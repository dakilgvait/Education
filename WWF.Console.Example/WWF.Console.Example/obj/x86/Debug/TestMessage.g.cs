...
namespace WWF.Console.Example {
    ...
    public partial class TestMessage : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TestMessage).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TestMessage));
        ...
        private string FindResource() {
            string[] resources = typeof(TestMessage).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TestMessage.g.xaml") || resource.Equals("TestMessage.g.xaml"))) {
                    return resource;
                }
            }
